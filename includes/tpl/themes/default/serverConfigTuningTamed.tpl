			...
			<thead>
				<tr>
					...
					<th class="text-center">
						<span data-toggle="tooltip" data-placement="right" title="Minimum Level Required to learn this Resource.">Damage Multiplier</span>
					...
					<th class="text-center">
						<span data-toggle="tooltip" data-placement="right" title="Minimum Level Required to learn this Resource.">Resistance Multiplier</span>
