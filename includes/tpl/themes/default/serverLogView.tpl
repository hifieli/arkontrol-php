...
<h2>View ARK Log - {$log_name}</h2>

<br>

<p><a href="/do/serverLogBrowse.php" class="btn btn-xl btn-primary">Back to list</a> <a href="javascript: history.go(0);" class="btn btn-xl btn-info">Refresh</a></p>
